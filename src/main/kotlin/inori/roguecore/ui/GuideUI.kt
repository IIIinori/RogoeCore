    ...
    fun open(player: Player) {
        player.openMenu<Chest>("§6§lRogueCore §7引导手册") {
            ...
            set(10, pageItem(XMaterial.IRON_SWORD, "§a基础冒险", listOf(
                "§7/rogue enter [floor] 开始冒险。",
                "§7清理战斗房后获得本局碎片和神恩选择。",
                "§7通关 Boss 房后可选择路线或离开结算。",
                "§7/rogue build 可查看当前构筑。"
            )))
            set(11, pageItem(XMaterial.DIAMOND_CHESTPLATE, "§e装备系统", listOf(
                "§7临时装备副本内直接使用，离开后消失。",
                "§7未鉴定装备在 §6/rogue identify §7中鉴定。",
                "§7锻造书在 §6/rogue craft §7中打造永久装备。",
                "§7永久装备可放入 §6/rogue gear §7仓库。"
            )))
            set(12, pageItem(XMaterial.AMETHYST_SHARD, "§d饰品系统", listOf(
                "§7饰品先进入背包，放入 §6/rogue accessory §7才生效。",
                "§7密封饰品在 §6/rogue aid §7中鉴定。",
                "§7饰品刻印书在 §6/rogue inscribe §7中刻印。",
                "§7饰品槽位: 项链、戒指、印记、护符、战利品。"
            )))
            set(13, pageItem(XMaterial.HOPPER, "§6回收工坊", listOf(
                "§7不需要的装备、饰品和书类可在 §6/rogue salvage §7回收。",
                "§7左键分解单件，Shift+左键分解同类。",
                "§7一键回收只处理低价值物品。",
                "§7收藏永久装备不会被分解。"
            )))
            set(14, pageItem(XMaterial.LECTERN, "§5收藏馆", listOf(
                "§7/rogue collection 打开收藏馆。",
                "§7提交史诗以上装备点亮主题收藏。",
                "§7提交传说饰品点亮槽位收藏。",
                "§7Boss 首杀会自动点亮并给一次奖励。"
            )))
            ...
            set(16, pageItem(XMaterial.COMPASS, "§b常用命令", listOf(
                "§7/rogue menu §f主菜单",
                "§7/rogue guide §f引导手册",
                "§7/rogue accessory §f饰品匣",
                "§7/rogue salvage §f回收工坊",
                "§7/rogue collection §f收藏馆"
            )))
            ...
            set(28, commandItem("§e装备相关", "/rogue identify", "/rogue craft", "/rogue gear", "/rogue forge"))
            set(29, commandItem("§d饰品相关", "/rogue accessory", "/rogue aworkshop", "/rogue aid", "/rogue inscribe"))
            set(30, commandItem("§6资源相关", "/rogue salvage", "/rogue materials", "/rogue workshop", "/rogue collection"))
